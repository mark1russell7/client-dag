 ...
 */
export declare function buildLeveledDAG<TNode extends DAGNode>(nodes: Map<string, TNode>): DependencyDAG<TNode>;
/**
 * Get the topological order (flat list, leaves first)
 */
export declare function getTopologicalOrder<TNode extends DAGNode>(dag: DependencyDAG<TNode>): TNode[];
/**
 * Visualize the DAG structure (for debugging)
 */
export declare function visualizeDAG<TNode extends DAGNode>(dag: DependencyDAG<TNode>): string;
